package br.ma.gov.imperatriz.contribuinte.contigenterps;

import br.ma.gov.imperatriz.contribuinte.contigenterps.dao.DAO;
...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        if (configuracaoEmail == null) {
            ...
            configuracaoEmail.setNome("[contigenteRPS]");
        ...
        salvarModeloEmail("[contigenteRPS] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[contigenteRPS] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
